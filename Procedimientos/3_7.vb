Module _3_7
    ...
    Sub main()
        ...
        Console.ReadKey()
    End Sub
    Friend Function calcular(ByVal operacion As Byte, ByVal num1 As Double, ByVal num2 As Double, ByVal num3 As Double) As Double
        Return calcular(operacion, calcular(operacion, num1, num2), num3)
    End Function
    Friend Function calcular(ByVal operacion As Byte, ByVal num1 As Double, ByVal num2 As Double, ByVal num3 As Double, ByVal num4 As Double) As Double
        Return calcular(operacion, calcular(operacion, num1, num2), calcular(operacion, num3, num4))
    End Function
    Friend Function calcular(ByVal num1 As Double, ByVal num2 As Double)
        Return calcular(1, num1, num2)
    End Function
    Friend Function calcular(ByVal operacion As Byte, ByVal num1 As Double, ByVal num2 As Double) As Double
        Dim x As Double
